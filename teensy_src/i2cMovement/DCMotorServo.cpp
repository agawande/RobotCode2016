...
//Serial.println(X1.distanceToGo() < 200);
...
Serial.println(Y2.getActualPosition());
  ...
  {
      X1.myPID->SetTunings(0.01,8,8);
      X2.myPID->SetTunings(0.01,8,8);
      Y1.myPID->SetTunings(0.01,8,8);
      Y2.myPID->SetTunings(0.01,8,8);
  }
  ...
  else
  {
      ...
      X1.myPID->SetTunings(3.2,0.2,0.15);
      X2.myPID->SetTunings(3.2,0.2,0.15);
      Y1.myPID->SetTunings(3.2,0.2,0.15);
      Y2.myPID->SetTunings(3.2,0.2,0.15);
  }
